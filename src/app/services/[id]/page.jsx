...
const page = async ({params}) => {
  ...
  const {title, description, _id, img, price, facility} = details.service;
  console.log(details);
  return (
      ...
      <div>
        <div className='relative h-72'>
          <Image
            ...
            style={{ width: "90vw" }}
          ></Image>
          <div className='absolute h-full left-0 top-0 flex items-center justify-center bg-slate-400'>
            <h1 className='text white text-3xl font-bold flex justify-center items-center'>services Details of {title}</h1>
          </div>
        </div>
